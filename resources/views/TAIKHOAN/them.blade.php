@extends('ADMIN/index')
@section('content')
<form method="POST" action="{{route('tai-khoan.xu-ly-them')}}">
	@csrf
	<div class="row">
					...
					<div class="row p-5 border-bottom">
						<div class="col-sm-12 col-md-12 col-xl-3">
							<div class="form-group">
								<label for="color-name" class="form-label text-muted">Tên tai khoản:</label>
								<div class="input-group">
									<input id="color-name" name="ten" type="text" class="form-control text-dark" placeholder="Enter ">
								</div>
								<label for="color-name" class="form-label text-muted">Mật khẩu:</label>
								<div class="input-group">
									<input id="color-name" name="password" type="text" class="form-control text-dark" placeholder="Enter ">
								</div>
							</div>
						</div>
...
<a href="{{ Route('loai.danh-sach') }}" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>LOẠI</a>
                    ...
                    <a href="{{ Route('tai-khoan.danh-sach') }}" class="nav-item nav-link active"><i class="fa fa-regular fa-user me-2"></i>TÀI KHOẢN</a>
