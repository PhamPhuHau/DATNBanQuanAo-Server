...
@section('content')
<form method="POST" action="{{ route('chi-tiet-loai.xl-them') }}">
    @csrf
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h4 class="mb-0">Thêm chi tiết loại</h4>
                </div>
                @if ($errors->any())
                ...
                <div class="card-body p-0 create-project-main">
                    <div class="row p-5 border-bottom">
                        <div class="col-sm-12 col-md-12 col-xl-6">
                            <div class="form-group">
                                <label for="material-name" class="form-label text-muted">Tên:</label>
                                <input id="material-name" name="ten" type="text" class="form-control text-dark" placeholder="Nhập tên">
                    ...
                    <div class="row p-5">
                        <div class="btn-list text-end">
                            <a class="btn btn-outline-danger" href="{{ route('chi-tiet-loai.danh-sach', ['loai_id' => $loai_id]) }}">
                                Hủy
                            </a>
