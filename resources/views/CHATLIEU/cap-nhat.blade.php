            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h4 class="mb-0">Cập nhật chất liệu</h4>
                    </div>
                    @if ($errors->any())
                    ...
                    <div class="card-body p-0 create-project-main">
                        <form method="POST" action="{{ route('chat-lieu.xl-cap-nhat', ['id' => $chat_lieu->id]) }}">
                            @csrf
                            <div class="row p-5 border-bottom">
                                <div class="col-sm-12 col-md-12 col-xl-3">
                                    <div class="form-group">
                                        <label for="chatlieu-name" class="form-label text-muted">Tên chất liệu:</label>
                                        <div class="input-group">
                                            <input id="chatlieu-name" name="ten" type="text" class="form-control text-dark" placeholder="Nhập tên chất liệu" value="{{ $chat_lieu->ten }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row p-5">
                                <div class="btn-list text-end">
                                    <a class="btn btn-outline-danger" href="{{ route('chat-lieu.danh-sach') }}">Cancel</a>
...
<a href="{{ Route('loai.danh-sach') }}" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>LOẠI</a>
                    ...
                    <a href="{{ Route('chat-lieu.danh-sach') }}" class="nav-item nav-link active"><i class="fa fa-chart-bar me-2"></i>CHẤT LIỆU</a>
