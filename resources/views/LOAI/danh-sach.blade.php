            ...
            <table class="table text-start align-middle table-bordered table-hover mb-0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>{{ $Loai->ten }}</td>
                        <td>
                            <a class="btn btn-outline-primary" href="{{ route('loai.cap-nhat', ['id'=>$Loai->id]) }}">Cập nhật</a>
                            <a class="btn btn-outline-danger" href="{{ route('loai.xoa', ['id'=>$Loai->id]) }}">Xóa</a>
                            <a class="btn btn-outline-dark" href="{{ route('chi-tiet-loai.danh-sach', ['loai_id'=>$Loai->id]) }}">Chi tiết</a>
                        </td>
                    </tr>
                </tbody>
                @endforeach
