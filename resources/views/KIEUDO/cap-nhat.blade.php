            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h4 class="mb-0">Cập nhật kiểu đồ</h4>
                    </div>
                    @if ($errors->any())
                    ...
                    <div class="card-body p-0 create-project-main">
                        <form method="POST" action="{{ route('kieu-do.xl-cap-nhat', ['id' => $kieu_do->id]) }}">
                            @csrf
                                ...
                                <div class="col-sm-12 col-md-12 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="kieudo-name" name="ten" type="text" class="form-control text-dark" placeholder="Nhập tên chất liệu" value="{{ $kieu_do->ten }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
